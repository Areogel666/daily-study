...
//		return "id:"+id+"	text:"+text+"	attributes:"+attributes+"	children:"+children;
		...
		Map<String, Object> map =new HashMap<String, Object>();
		map.put("DBPROV", "000");
		map.put("DBACCNO", "1212");
		map.put("DBCUR", "ATTRIBUTES444444");
		
		try {
			req = mapToBean(ABCCmpReq.class, map);
			mapToObject(map, req);
			req = mapToObject(map, ABCCmpReq.class);
			System.err.println(req.toString());
			System.err.println("===============================");
			Map<String, Object> map2 = objectToMap(req);
//			Map<String, Object> map2 = beanToMap(req);
