...
public class BigDecimalUtil {
    ...
    */    
     ...
     * @return 两个参数的和   
     */    
    public static double addAll(List<Double> v){ 
    	BigDecimal sum = new BigDecimal(0);    
    	for (Double addition : v) {
    		BigDecimal b = BigDecimal.valueOf(addition);    
    		sum = sum.add(b);
		}
    ...
    public static double sub(Object v1,Object v2){
    	...
    	if(StringUtils.isBlank(v2))
    		v2="0";
        BigDecimal b1 = new BigDecimal(isNum(v1.toString())?v1.toString():"0");    
        BigDecimal b2 = new BigDecimal(isNum(v2.toString())?v2.toString():"0");    
        return b1.subtract(b2).doubleValue();    
    }       
    /**   
     * 提供精确的乘法运算。   
