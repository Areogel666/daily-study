...
public class ZipUtils 
{
		...
		public static synchronized void zip(File inputFile,OutputStream os,String base, String charSetName) throws IOException {
			ZipOutputStream out = new ZipOutputStream(os);
			try {
				zip(inputFile, out, base,charSetName);
			} catch (IOException e) {
				throw e;
			} finally {
				out.closeEntry();
